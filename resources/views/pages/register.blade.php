                   ...
                   <div class="modal-body">
                    ...
                    enctype="multipart/form-data">
                        <div class="form-group" id="register-fname">
                              ...
                              <label class="control-label" for="fname" style="color:grey"> First Name
                            ...
                            <div class="form-group" id="register-username">
                                <label class="control-label" for="name" style="color:grey"> UserName</label> <input class="form-control" id="username" name="username"
                                 placeholder="choose name" required="" title="Please enter you name" type="text">                                                                                                                                              <span class="help-block"><strong id="register-errors-username"></strong></span> <span class="help-block small">Your name</span>
                            </div>

                            <div class="form-group" id="register-email">
                                {{ csrf_field() }} <label class="control-label" for="email" style="color:grey">Email</label> <input class="form-control" id="email" name="email" placeholder="example@gmail.com" required="" title="Please enter you email" type="email" value=""> <span class="help-block"><strong id="register-errors-email"></strong></span> <span class="help-block small">Your email</span>
                            </div>
                            ...
                            <div class="form-group" id="register-password">
                               ...
                               <span class="help-block"><strong id="register-errors-password"></strong></span> <span class="help-block small">Your strong password</span>
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="password-confirm" style="color:grey">Confirm Password</label> <input class="form-control" id=
                                "password-confirm" name="password_confirmation" placeholder="******" type="password"> <span class= "help-block"><strong id="form-errors-password-confirm"></strong></span>
                            </div>
                            ...
                            <div class="form-group" id="register-address">
                                ...
                                plaeholder="choose name" required="" title="Please enter you name" type="text"> <span class="help-block"><strong id="register-errors-address"></strong></span> <span class="help-block small"></span>
                            </div>
                    ...
                    <label for='pic'class="col-md-4 control-label" style="color:grey">Profile picture</label>
                                <div class="col-md-6" style="color:grey">
                                   <input style="color:grey" type="file" id="pic" name="pic" class="" data-multiple-caption="{count} files selected" multiple />
                                </div>
                          </div>
